...
Your **Windows 365 desktop** comes pre-configured with VS Code and GitHub Copilot — but depending on your chosen scenario, you may need additional tools (Node.js, .NET, Python, Azure CLI, etc.). Each scenario's README includes a Copilot prompt to check your environment and install anything that's missing. A **Microsoft CSA or SE** is also on hand to help make sure you're fully set up before you dive in.
...
| # | Scenario | Description | Difficulty | Tech Stack |
| --- | --- | --- | --- | --- |
| 1 | [SLED Case Management CRUD App](./AI%20Prompt%20Scenarios/Prompt-Scenario-1/README.md) | Secure case management system for a county agency | Intermediate | .NET 10 · React · Cosmos DB · Bicep |
| 2 | [IaaS Lift & Shift: Permit Management](./AI%20Prompt%20Scenarios/Prompt-Scenario-2/README.md) | Lift-and-shift permit management system to Azure VMs | Intermediate | .NET 8 · SQL Server VM · IIS · Bicep |
| 3 | [AI Constituent Services Chatbot](./AI%20Prompt%20Scenarios/Prompt-Scenario-3/README.md) | RAG-powered chatbot for government services using Azure OpenAI + Azure AI Search | Advanced | Python · FastAPI · React · Azure OpenAI · AI Search · Bicep |
...
> The three challenge scenarios include their own self-contained **Bicep** templates generated by Copilot — they deploy independently and do not require the Accelerator. The Accelerator is intended as a shared baseline for PoC and testing purposes — not for production use.
